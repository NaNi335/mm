...
origin_img_1 = code_1.rgb_to_gray(imread('iguana.jpg'))
origin_img_2 = imread('Parrot.jpg')
final_img_1 = code_1.quantum(origin_img_1, 64)
final_img_2 = code_2.yuv_to_rgb('Parrot.jpg', 4)
...
def entropy_one_chanel(img):
    ...
    for elem in p:
        if elem != 0:
            h_list.append(- elem * math.log(elem, 2))
        else:
            pass
    h = sum(h_list)
    return h
